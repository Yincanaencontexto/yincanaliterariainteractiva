...
export const CompletionScreen: React.FC<CompletionScreenProps> = ({ score, totalScore, onRestart }) => {
  const handleDownloadCertificate = () => {
    ...
    const certificateUrl = 'https://www.example.com/certificado_yincana.pdf'; // IMPORTANT: Replace with actual URL
  ...
  return (
    <div className={`flex flex-col items-center justify-center min-h-screen p-4 md:p-6 ${COLORS.primary} animate-fadeIn`}>
